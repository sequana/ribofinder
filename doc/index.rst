Sequana ribofinder pipeline documentation
#####################################################

|version|, |today|, status: production

The **ribofinder** pipeline is a `Sequana <https://github.com/sequana/sequana>`__ pipeline. You can find the source code 
on  `https://github.com/sequana/sequana_ribofinder <https://github.com/sequana/sequana_ribofinder/>`_. Would you have issues
about the code, usage or lack of information, please fill a report 
on `Sequana itself <https://github.com/sequana/sequana/issues>`__ indicating the pipeline name (We centralized all 
...
The Sequana ribofinder pipeline
==============================================
